...
public class GeneralSlime extends SpawnedSlime {
    ...
    public GeneralSlime() {
        super(ID, new Color(0.5f, 0.5f, 0.8f, 1f), atlasString, skeletonString, false, false, 0, 2, false, new Color(0.4F, 0.4F, 0.8F, 1), SlimeFlareEffect.OrbFlareColor.LICKING, new Texture("slimeboundResources/SlimeboundImages/orbs/command.png"));
    ...
    public void activateEffectUnique() {
        AbstractDungeon.actionManager.addToBottom(new CommandRandomSlimesAction(2));
    }
